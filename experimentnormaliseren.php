            ...
            <div class="row">
                ...
                <div class="col-md-12 col-md-offset-0 animate-box" data-animate-effect="fadeInLeft">
                    ...
                    <div class="col-md-9 col-md-push-2">
                        <h1>6.1.1 Experimenteel onderzoek: normaliseren</h1>
                        ...
                        <h4>6.1.1.2 Beschrijving onderzoeksprocedure</h4>
                        <p><b.>1. </b.>Accord.Imaging wordt via NuGet Packages gedownload in Microsoft Visual Studio. De verschillende filters zijn nu te bereiken door het aanmaken van een filter klasse. De documentatie over deze filters zijn te vinden via de volgende url : <a href="http://accord-framework.net/docs/html/N_Accord_Imaging_Filters.htm"> accord-framework.net</a>.
                        <br>
                            <b>2. </b>2.	Vervolgens worden vijf afbeeldingen door het aangemaakte filter gehaald. Hierbij is gekozen voor een afbeelding met 1 gezicht, en vier afbeeldingen met meerdere gezichten. Hiermee wordt gecontroleerd, of het detecteren zowel met één als meerdere personen werkt. Daarnaast wordt er gewerkt met personen met zowel donkere als lichte huidskleuren. Op deze manier kan worden gecontroleerd of de huidskleur nog invloed heeft op het detecteren. Vervolgens wordt er gekeken naar afbeeldingen met zowel een lichte, als een donkere omgeving. Op deze manier kan de invloed van de omgeving worden gecontroleerd.
                            <br> <b>3. </b>De filter klassen worden aangeroepen met verschillende waardes. Op deze manier kan worden onderzocht wat het effect van de verschillende waardes heeft op de afbeelding. De waardes zijn bepaald aan de hand van de informatie te vinden op: <a href="http://accord-framework.net/docs/html/N_Accord_Imaging_Filters.htm"> accord-framework.net</a>.
                            <br><b>4. </b>4.	Ten slotte wordt er een request gedaan op de detectie API met de gemanipuleerde afbeeldingen. De response toont of het detecteren wel of niet gelukt is, en in hoeverre het goed gelukt is. Op deze manier kan worden gekeken welk filter met bijbehorende waarden het meest geschikt is voor gezichtsdetectie.

                        </p>
                        <img src="images/afbeelding12.png">
                       <br> <button> <a href="http://verslag.localhost/resultaten.php">Resultaten</a></button>
